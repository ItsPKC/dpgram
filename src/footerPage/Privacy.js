...
const Privacy = () => {
  return (
    <div className="SpaceOptimiser">
      ...
      <h3 class="text-xl py-2">Definitions</h3>
      ...
      <ul class="list-disc pl-6">
        <li>
          ...
          collects Consumers&rsquo; personal information and determines the
          purposes and means of the processing of Consumers&rsquo; personal
          ...
          of the processing of consumers&rsquo; personal information, that does
          business in the State of California.
        </li>
        <li>
          <strong>Company</strong> (referred to as either &ldquo;the
          Company&rdquo;, &ldquo;We&rdquo;, &ldquo;Us&rdquo; or
          &ldquo;Our&rdquo; in this Agreement) refers to dpGram IO, Unated
          States, Alaska. For the purpose of the GDPR, the Company is the Data
          Controller.
        </li>
        <li>
        ...
        <li>
          ...
          Consumer&rsquo;s Personal information to another business or a third
        ...
        <li>
          <strong>Website</strong> refers to dpGram, accessible from{" "}
          <a
            class="underline hover:text-blue-500"
            href="https://dpgram.com"
            target="_blank"
      ...
      <h2 class="text-3xl py-4">Collecting and Using Your Personal Data</h2>
      <h3 class="text-xl py-2">Types of Data Collected</h3>
      <h4>Personal Data</h4>
      <p>
      ...
      <ul class="list-disc pl-6">
        <li>
          ...
          fraudulent use. Without these Cookies, the services that You have
        ...
        <li>
          ...
          choices You make when You use the Website, such as language
        ...
        <li>
          ...
          Cookies Administered by: Third-Parties Purpose: These Cookies are used
          to track information about traffic to the Website and how users use
          the Website. The information gathered via these Cookies may directly
          or indirectly identify you as an individual visitor. This is because
        ...
        <li>
          <strong>Targeting and Advertising Cookies</strong> Type: Persistent
          Cookies Administered by: Third-Parties Purpose: These Cookies track
          your browsing habits to enable Us to show advertising which is more
      ...
      <h3 class="text-xl py-2">Use of Your Personal Data</h3>
      ...
      <ul class="list-disc pl-6">
        ...
        <li>
          ...
          application&rsquo;s push notifications regarding updates or
        ...
        <li>
          ...
          are similar to those that you have enquired about unless You have
      ...
      <h3 class="text-xl py-2">Retention of Your Personal Data</h3>
      <p>
      ...
      <h3 class="text-xl py-2">Transfer of Your Personal Data</h3>
      <p>
      ...
      <h3 class="text-xl py-2">Disclosure of Your Personal Data</h3>
      ...
      <h3 class="text-xl py-2">Security of Your Personal Data</h3>
      <p>
      ...
      <h3 class="text-xl py-2">Analytics</h3>
      <p>
      ...
      <h3 class="text-xl py-2">Advertising</h3>
      <p>
      ...
      <ul class="list-disc pl-6">
        <li>
          ...
          Google&rsquo;s use of the DoubleClick cookie enables it and its
        ...
        <li>
          <strong>LinkedIn</strong> Their Privacy Policy can be viewed at{" "}
          <a
            class="underline hover:text-blue-500"
        ...
        <li>
          <strong>Facebook</strong> Their Privacy Policy can be viewed at{" "}
          <a
            class="underline hover:text-blue-500"
      ...
      <h3 class="text-xl py-2">Email Marketing</h3>
      <p>
      ...
      <h3 class="text-xl py-2">Payments</h3>
      <p>
      ...
      <h3 class="text-xl py-2">Behavioral Remarketing</h3>
      <p>
      ...
      <ul class="list-disc pl-6">
        <li>
          <strong>Google Ads (AdWords)</strong> Google Ads (AdWords) remarketing
          ...
          &ndash; for your web browser. Google Analytics Opt-out Browser Add-on
      ...
      <h3 class="text-xl py-2">Usage, Performance and Miscellaneous</h3>
      <p>
      ...
      <ul class="list-disc pl-6">
        <li>
          <strong>Invisible reCAPTCHA</strong> We use an invisible captcha
          service named reCAPTCHA. reCAPTCHA is operated by Google. The
          reCAPTCHA service may collect information from You and from Your
          Device for security purposes. The information gathered by reCAPTCHA is
      ...
      <h2 class="text-3xl py-4">GDPR Privacy</h2>
      ...
      <h3 class="text-xl py-2">Your Rights under the GDPR</h3>
      <p>
      ...
      <h2 class="text-3xl py-4">CCPA Privacy</h2>
      <h3 class="text-xl py-2">Your Rights under the CCPA</h3>
      <p>
      ...
      <ul class="list-disc pl-6">
        ...
        <li>
          ...
          third-party for the third party&rsquo;s direct marketing purposes.
        </li>
        <li>
          ...
          &ldquo;Do Not Sell My Personal Information&rdquo; section or web page.
        </li>
        <li>
        ...
        <li>
          ...
          Consumer&rsquo;s rights, including by:
          <ul class="list-disc pl-6">
      ...
      <h3 class="text-xl py-2">Exercising Your CCPA Data Protection Rights</h3>
      <p>
        In order to exercise any of Your rights under the CCPA, and if you are a
        California resident, You can email or call us or visit our &ldquo;Do Not
        Sell My Personal Information&rdquo; section or web page.
      </p>
      <p>
      ...
      <h3 class="text-xl py-2">Do Not Sell My Personal Information</h3>
      <p>
        ...
        on the Service that &ldquo;sells&rdquo; personal information as defined
        by the CCPA law.
      </p>
      <p>
      ...
      <ul class="list-disc pl-6">
        <li>From Our &ldquo;Cookie Consent&rdquo; notice banner</li>
        <li>Or from Our &ldquo;CCPA Opt-out&rdquo; notice banner</li>
        <li>
          Or from Our &ldquo;Do Not Sell My Personal Information&rdquo; notice
          banner
        </li>
        <li>
          Or from Our &ldquo;Do Not Sell My Personal Information&rdquo; link
        </li>
      </ul>
      <p>
      ...
      <ul class="list-disc pl-6">
        ...
        <li>&ldquo;Limit Ad Tracking&rdquo; on iOS devices</li>
      </ul>
      <p>
      ...
      <h2 class="text-3xl py-4">Links to Other Websites</h2>
      <p>
      ...
      <h2 class="text-3xl py-4">Changes to this Privacy Policy</h2>
      <p>
      ...
      <h2 class="text-3xl py-4">Contact Us</h2>
      <p>
      ...
      <ul class="list-disc pl-6">
        <li>
          ...
          <a
            class="underline hover:text-blue-500"
            href="https://dpgram.com/contact-us/"
            target="_blank"
            rel="noreferrer noopener"
          >
            https://dpgram.com/contact-us/
          </a>
        </li>
      </ul>
    </div>
