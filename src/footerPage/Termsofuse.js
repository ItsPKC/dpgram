...
const Termsofuse = () => {
  return (
    <div className="SpaceOptimiser">
      <h1 class="text-3xl py-6">Terms and Conditions</h1>
      <p>Last updated: February 06, 2021</p>
      <p>
        Please read these terms and conditions carefully before using Our
        Service.
      </p>
      <h1 class="text-3xl py-6">Interpretation and Definitions</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to dpGram.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a href="https://dpgram.com/">https://dpgram.com/</a>
          </p>
        </li>
        <li>
          <p>
      ...
      <h1 class="text-3xl py-6">Acknowledgment</h1>
      <p>
      ...
      <h1 class="text-3xl py-6">Links to Other Websites</h1>
      <p>
      ...
      <h1 class="text-3xl py-6">Termination</h1>
      <p>
      ...
      <h1 class="text-3xl py-6">Limitation of Liability</h1>
      <p>
      ...
      <h1 class="text-3xl py-6">Governing Law</h1>
      <p>
      ...
      <h1 class="text-3xl py-6">Disputes Resolution</h1>
      <p>
      ...
      <h1 class="text-3xl py-6">For European Union (EU) Users</h1>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h1 class="text-3xl py-6">United States Legal Compliance</h1>
      <p>
      ...
      <h1 class="text-3xl py-6">Severability and Waiver</h1>
      <h2>Severability</h2>
      <p>
      ...
      <h1 class="text-3xl py-6">Translation Interpretation</h1>
      <p>
      ...
      <h1 class="text-3xl py-6">Changes to These Terms and Conditions</h1>
      <p>
      ...
      <h1 class="text-3xl py-6">Contact Us</h1>
      <p>
      ...
      <ul>
        <li>
          ...
          <a
            ...
            class="__cf_email__"
            data-cfemail="640d03160509000b100d0b240309050d084a070b09"
          >
            [email&#160;protected]
          </a>
        </li>
